...
import com.example.clinicacare.presentation.doctor.return_screen.AppointmentReturnViewModel
import com.example.clinicacare.presentation.doctor.return_screen.event.ReturnEvent

@Composable
fun TimeCustomDialog(
    onDismiss: () -> Unit,
    onConfirm: () -> Unit,
    appointments: MutableList<String>,
    viewModel: AppointmentReturnViewModel,
    date: Boolean
) {
    ...
    var selectedItem by remember { mutableStateOf(viewModel.returnState.value.time) }
                ...
                if (date) {
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                onConfirm()
                                viewModel.onEvent(ReturnEvent.OnTimeChange(selectedItem))
                            },
                            colors = ButtonDefaults.buttonColors(
                                containerColor = MaterialTheme.colorScheme.secondary,
                                contentColor = MaterialTheme.colorScheme.primary
