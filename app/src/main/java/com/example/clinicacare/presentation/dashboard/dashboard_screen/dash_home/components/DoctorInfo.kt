package com.example.clinicacare.presentation.dashboard.dashboard_screen.dash_home.components
...
fun DoctorInfo(
    ...
    Scaffold(
        ...
        LaunchedEffect(key1 = itemIndex) {
            if (itemIndex != "-1") {
                dashboardViewModel.onEvent(DashboardEvent.OnShowDoctorInfo(itemIndex))
            }
        }
